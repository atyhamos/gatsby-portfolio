    ...
    <div className='trax-container' id='info'>
      ...
      <div className='project-details'>
        ...
        <p>
          ...
          we conduct lessons for underprivleged children. However, as volunteers
          often come and go, it's hard for the children to progress academically
          with no fixed record of their performance over time.
        </p>
        <img
          src={StudentFeedback}
        ...
        <p>
          ...
          <Highlight>conduct effective lessons.</Highlight> Importantly, another
          goal is to make the application responsive and easy-to-use.
        </p>
      </div>
      <div className='tech-stack-details'>
        ...
        <p>
          ...
          initially opted against using Redux for state management as I thought
          it would be overkill, but as the application grew larger, I had second
          thoughts, but ultimately decided against it anyway.
        </p>
        <p>
          ...
          , serving my needs well with fewer lines of code. Other considerations
          were to use ExpressJS with MongoDB to serve data at endpoints, but I
          wanted to focus more on the frontend aspects of this project.
        </p>
        <p>
      ...
      <div className='problem-details '>
        ...
        <p>
          ...
          due to the number of contexts to keep track of, properly updating each
          one whenever an event is triggered and{' '}
        ...
        <p>
          ...
          code completely to better suit my project, creating generic components
          and passing them props instead of creating a 100 unique components
          with slight variations.
        </p>
        <p>
          Additionally, with dozens of components in the codebase, each with
          their own styling, <Highlight>stylesheets became cluttered</Highlight>{' '}
          and confused.
        </p>
      </div>
      <div className='lessons-details '>
        ...
        <p>
          ...
          requirements, and to work in iterations. While diving head first into
          a project is a lot quicker in the short-run, it will ultimately lead
          to unforeseen issues that drags out the development process.
        </p>
        <p>
          ...
          <ul>
            <li>
              Using{' '}
              <Highlight backgroundColor={colorYellowDark}>Redux</Highlight> for
              state management.
            </li>
            <li>

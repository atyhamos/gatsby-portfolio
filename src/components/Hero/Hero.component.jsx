  ...
  return (
    <div id='home' className='hero-container'>
      ...
      >
        ...
        <p>
          I used to study{' '}
          <span className='highlight-arts'>visual arts and design.</span> Now, I
          hope to make beautiful,{' '}
          <span className='highlight-responsive'>responsive</span> websites and
          applications that are enjoyable to use.
        </p>
